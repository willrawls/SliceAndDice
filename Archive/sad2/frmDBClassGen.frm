...
90       End If
       ...
       ' Look for special table specific template
...
136      If gbCancelInsertion Then Exit Sub
         ...
         If Not Parent.SliceAndDice.Categorys(sCategoryName).Templates("Collection Member - Finalize") Is Nothing Then
             Parent.DoInsertion asaV, sDataLibraryType & "Collection Member - Finalize"
         ElseIf Not Parent.SliceAndDice.Categorys(sCategoryName).Templates("Collection Member, Finalize") Is Nothing Then
             Parent.DoInsertion asaV, sDataLibraryType & "Collection Member, Finalize"
         ElseIf Not Parent.SliceAndDice.Categorys(sCategoryName).Templates("Finalize Collection Member") Is Nothing Then
             Parent.DoInsertion asaV, sDataLibraryType & "Finalize Collection Member"
         End If
         If gbCancelInsertion Then Exit Sub

         If Not Parent.SliceAndDice.Categorys(sCategoryName).Templates("Collection - Finalize") Is Nothing Then
             Parent.DoInsertion asaV, sDataLibraryType & "Collection - Finalize"
         ElseIf Not Parent.SliceAndDice.Categorys(sCategoryName).Templates("Collection, Finalize") Is Nothing Then
             Parent.DoInsertion asaV, sDataLibraryType & "Collection, Finalize"
         ElseIf Not Parent.SliceAndDice.Categorys(sCategoryName).Templates("Finalize Collection") Is Nothing Then
             Parent.DoInsertion asaV, sDataLibraryType & "Finalize Collection"
         End If
         If gbCancelInsertion Then Exit Sub
...
Public Function sFieldType(ByVal iFieldType As Long, ByVal sFieldName As String) As String
...
502          Case dbVarBinary: sFieldType = "VarBinary"
             ...
             Case Else:
                  If UCase$(Right$(sFieldName, 2)) = "ID" Then
                     sFieldType = "Guid"
                  Else
                     sFieldType = "Text"
                  End If
...
901              litX.SubItems(1) = sFieldType(CurField.Type, CurField.Name)
