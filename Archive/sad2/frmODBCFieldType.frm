VERSION 5.00
Begin VB.Form frmODBCFieldType 
   ...
   Begin VB.TextBox txtLength 
      ...
      MultiLine       =   -1  'True
      TabIndex        =   2
      Text            =   "frmODBCFieldType.frx":0000
      Top             =   3330
      Width           =   1605
   End
   Begin VB.ListBox lstType 
      ...
      ItemData        =   "frmODBCFieldType.frx":0004
      Left            =   60
      List            =   "frmODBCFieldType.frx":0026
      TabIndex        =   1
      Top             =   900
      Width           =   1605
   End
   ...
   End
End
Attribute VB_Name = "frmODBCFieldType"
