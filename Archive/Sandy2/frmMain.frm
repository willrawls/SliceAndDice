...
' ********************************************************
                        Case "COMMENTEDPARAMETERS"          ' Parse a function's parameters into readable comments
                             ...
                             If sProcName <> vbNullString Then
                                II.sParam = CurModule.Lines(CurModule.ProcBodyLine(sProcName, lProcType), 1) ' Get the procedure's header
                                ...
                                Else
                                   sHold1 = vbNullString
                                End If
                                If lTokenCount(II.sParam, ")") > 0 Then
