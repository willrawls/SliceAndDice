		...
		public class frmRegisterCodeSnippet : System.Windows.Forms.Form
		{
		 ...
		 public System.Windows.Forms.VB.Label Label10;
			...
			public void InitializeComponent()
			{
				...
				this.Text = "VB5 Add-in registration tool";
			...
			public void RegisterIt()
			{
				...
				Do Until EOF(fh);
				Input #fh, sLine;
				if ( InStr(UCase(sLine), UCase(txtObjectName)) > 0 )
				{;
			...
			public void cmdRemoveAddin_Click()
			{
				...
				Do Until EOF(fh);
				Input #fh, sLine;
				if ( InStr(sLine, txtObjectName) = 0 )
				{;
			...
			public void Form_Load()
			{
				...
				if ( UCase(Command) = "REGISTER SLICE AND DICE" )
				{;
				RegisterIt;
				End;
				};
